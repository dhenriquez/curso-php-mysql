		...
		<div class="row">
			...
			<div class="col-12 col-md-3">
				<div class="card">
					...
					<div class="card-body">
						<p class="card-text">
						<strong>Desde:</strong> <br> <?php echo $pronostico['desde'];?><br>
						<strong>Hasta:</strong> <br> <?php echo $pronostico['hasta'];?><br>
						<strong>Condición:</strong> <br> <?php echo $pronostico['condicion'];?><br>
						<strong>Temperatura:</strong> <br> <?php echo $pronostico['temperatura'];?>°<br>
						<strong>Precipitaciones:</strong> <br> <?php echo $pronostico['precipitacion'];?>
						</p>
					</div>
				</div>
			</div>
